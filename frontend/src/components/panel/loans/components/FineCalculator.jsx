...
const FineCalculator = ({ loan, onClose }) => {
    ...
    const getFineTypeColor = (type) => {
        ...
        return colors[type] || 'bg-slate-900 text-slate-200 border-slate-700/50';
    };
                ...
                <div className="p-6 space-y-6">
                    ...
                    {loanFines.length > 0 && (
                        <div className="bg-slate-700 rounded-lg p-4 border border-slate-600">
                            ...
                            <div className="space-y-3">
                                {loanFines.map((fine) => (
                                    <div key={fine.id} className="bg-slate-600 rounded-lg p-3 border border-slate-500">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-slate-300 text-sm">{fine.description}</p>
                    ...
                    {loadingData ? (
                        <div className="flex items-center justify-center p-8">
                            ...
                            <span className="text-slate-300">Cargando multas del cliente...</span>
                        </div>
                    ) : (
                        <div className="bg-slate-700 rounded-lg p-4 border border-slate-600">
                            <h3 className="text-lg font-medium text-white mb-3">
                            ...
                            {clientFines.length === 0 ? (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-slate-400">Este cliente no tiene multas registradas</p>
                                </div>
                            ) : (
